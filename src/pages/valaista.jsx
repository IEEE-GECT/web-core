              ...
              <div className="relative wrap overflow-hidden p-10 h-full">
                ...
                <div className="mb-8 flex justify-between items-center w-full right-timeline">
                  ...
                  <div className="order-1 w-full sm:w-5/12 px-1 py-4 text-left ml-1 sm:ml-0">
                    ...
                    <p className="text-sm md:text-base leading-snug text-gray-50 text-opacity-100 mb-4">
                      WORKSHOP CONTENT <br></br>⚜️ Introduction to Augmented
                      Reality and virtual reality<br></br> ⚜️ AR Devices and VR
                      Devices <br></br>⚜️Development platforms <br></br>⚜️
                      Augmented Reality Industrial application ⚜️Demonstration
                      of AR
                    </p>
                    <Link
                      to="/e/aurea"
