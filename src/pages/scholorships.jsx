...
let scholarships = [
  {
    ...
    "description": "Express a willingness to consider a career in power and energy engineering",
    "eligibility": [
    ...
    "fund": {
      ...
      "expenses": "Up to Rs. 25,000 towards attending seminars, conferences, etc."
    },
    "apply": "https://r10.ieee.org/ic-pes/ipisa-2/"
  },
  {
    "name": "Undergraduate/Pre graduate Scholarship Program",
    "description": "Applicant must be a BS, BS/MS or MS student in electrical engineering (or related field). The faculty mentor must be an IEEE MTT-S member.",
  ...
  },
  {
    ...
    "description": "Student, who is the principal author and presenter, must be a registered student of an educational institution at the time of paper submission.",
    "frequency": "Annually",
  ...
  },
  {
    ...
    "apply": "https://www.ieee-ies.org/about/awards/awards-info/186-ies-student-best-paper-award"
  },
  {
    ...
    "apply": "https://eds.ieee.org/education/student-fellowships/undergraduate-student-scholarships"
  },
  {
    "name": "Caixin Sun and Stanislaw Grzybowski Best Student Paper Award",
    "description": "IEEE Caixin Sun and Stanislaw Grzybowski Best Student Paper Awards will be given at each IEEE International Conference on High Voltage Engineering and Applications (ICHVE).",
    "eligibility": [
  ...
  },
  {
    ...
    "description": "To recognize excellence in a CCTA paper whose primary contributor(s) is a (are) student member(s) of the IEEE.",
    "eligibility": "Primary contributor(s) who was a (were) student(s) at the time of original submission.",
  ...
  },
  {
    ...
    "more_info": "https://ieee-aess.org/awards/education-awards/engineering-scholarship"
  },
  {
    "name": "IEEE Broadcast Technology Society / AFCCE Jules Cohen Memorial Scholarships",
    "description": "Scholarships of up to $10,000 to promising undergraduate and graduate students interested in a career in broadcast engineering.",
    "eligibility": [
  ...
  },
  {
    ...
    "description": "Recognizes a student paper of exceptional interest and applicability to the field of Broadcast Engineering.",
    "eligibility": "Any student pursuing a course of study in a field related to broadcast engineering",
    "fund": {
      "first_prize": "$250, Certificate and trip to Annual Broadcast Symposium",
      "second_prize": "$250, Certificate, and complimentary registration to the Annual Broadcast Symposium",
      "third_prize": "$250, Certificate, and complimentary registration to the Annual Broadcast Symposium"
    },
          ...
          <div className="itemdata">
            {Array.isArray(data)
              ? data.map((item, itemIndex) => (
                  <div className="listitem" key={itemIndex}> {item}</div>
                ))
              : (typeof data === 'object'
